...
struct RegisterView: View {
    ...
    @StateObject private var vm = RegistrationViewModelImpl (service:
        ...
        NavigationView{
            VStack(spacing: 32){
                VStack(spacing: 16){
                    ...
                    InputTextFieldView(text: $vm.userDetails.city, placeholder: "City", keyboardType: .namePhonePad, sfSymbol: nil)
                }
